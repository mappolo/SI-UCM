...
public class MapCSP extends CSP {
	...
	public static final Variable XX = new Variable("XX");
	public static final String RED = "RED";
	public static final String GREEN = "GREEN";
	public static final String BLUE = "BLUE";
	
	// Nuevo color
	public static final String NARANJITO = "NARANJITO";
	...
	public MapCSP() {
		...
		Domain colors = new Domain(new Object[] { RED, GREEN, BLUE, NARANJITO });
		...
		addConstraint(new NotEqualConstraint(WA, XX));
		addConstraint(new NotEqualConstraint(XX, V));
	}
}