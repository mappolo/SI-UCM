    ...
    extends TestCase
{
     ...
     */
    public SimmulatedAnnealingTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( SimmulatedAnnealingTest.class );
    }
    ...
    public List<Action> getActions(VacuumState initialState) throws Exception{
    	...
    	aima.core.search.local.SimulatedAnnealingSearch hcs=
    			new aima.core.search.local.SimulatedAnnealingSearch(hf);   	    	
    ...
    public static void main(String args[]) throws Exception{
    	SimmulatedAnnealingTest dfst=new SimmulatedAnnealingTest("SimmulatedAnnealing");
    	int[][] world=new int[][]{
    			new int[]{0,0,0},
    			new int[]{0,0,0},
    			new int[]{0,5,0}};
